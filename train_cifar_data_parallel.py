...
def main():
    ...
    parser.add_argument('--gpu1', type=int, default=1,
                        help='GPU ID (negative value indicates CPU)')
    parser.add_argument('--gpu2', type=int, default=2,
                        help='GPU ID (negative value indicates CPU)')
    parser.add_argument('--gpu3', type=int, default=3,
                        help='GPU ID (negative value indicates CPU)')
    ...
    print('GPU: {} {} {} {}'.format(args.gpu0, args.gpu1, args.gpu2, args.gpu3))
    ...
    model = L.Classifier(models.VGG.AllConvNetBN(class_labels))
    #model = L.Classifier(models.VGG.VGG(class_labels))
    chainer.cuda.get_device(args.gpu0).use()  # Make a specified GPU current
